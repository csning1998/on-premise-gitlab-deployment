...
terraform {
  ...
  backend "http" {
    address        = "https://gitlab.com/api/v4/projects/82448331/terraform/state/infra-harbor-redis"
    lock_address   = "https://gitlab.com/api/v4/projects/82448331/terraform/state/infra-harbor-redis/lock"
    unlock_address = "https://gitlab.com/api/v4/projects/82448331/terraform/state/infra-harbor-redis/lock"
    lock_method    = "POST"
