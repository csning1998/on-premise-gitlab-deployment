...
terraform {
  ...
  backend "http" {
    address        = "https://gitlab.com/api/v4/projects/82448331/terraform/state/provision-observability-frontend"
    lock_address   = "https://gitlab.com/api/v4/projects/82448331/terraform/state/provision-observability-frontend/lock"
    unlock_address = "https://gitlab.com/api/v4/projects/82448331/terraform/state/provision-observability-frontend/lock"
    lock_method    = "POST"
