...
terraform {
  ...
  backend "http" {
    address        = "https://gitlab.com/api/v4/projects/82448331/terraform/state/provision-observability-minio"
    lock_address   = "https://gitlab.com/api/v4/projects/82448331/terraform/state/provision-observability-minio/lock"
    unlock_address = "https://gitlab.com/api/v4/projects/82448331/terraform/state/provision-observability-minio/lock"
    lock_method    = "POST"
