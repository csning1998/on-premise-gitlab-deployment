...
terraform {
  ...
  backend "http" {
    address        = "https://gitlab.com/api/v4/projects/82448331/terraform/state/50-platform-harbor-frontend"
    lock_address   = "https://gitlab.com/api/v4/projects/82448331/terraform/state/50-platform-harbor-frontend/lock"
    unlock_address = "https://gitlab.com/api/v4/projects/82448331/terraform/state/50-platform-harbor-frontend/lock"
    lock_method    = "POST"
