...
locals {
  # Service Identity
  svc_name     = var.gitlab_minio_compute.cluster_identity.service_name
  comp_name    = var.gitlab_minio_compute.cluster_identity.component
  layer_number = var.gitlab_minio_compute.cluster_identity.layer_number
