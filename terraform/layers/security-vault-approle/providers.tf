...
terraform {
  ...
  backend "http" {
    address        = "https://gitlab.com/api/v4/projects/82448331/terraform/state/security-vault-approle"
    lock_address   = "https://gitlab.com/api/v4/projects/82448331/terraform/state/security-vault-approle/lock"
    unlock_address = "https://gitlab.com/api/v4/projects/82448331/terraform/state/security-vault-approle/lock"
    lock_method    = "POST"
