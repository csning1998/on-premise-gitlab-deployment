...
terraform {
  ...
  backend "http" {
    address        = "https://gitlab.com/api/v4/projects/82448331/terraform/state/infra-gitlab-minio"
    lock_address   = "https://gitlab.com/api/v4/projects/82448331/terraform/state/infra-gitlab-minio/lock"
    unlock_address = "https://gitlab.com/api/v4/projects/82448331/terraform/state/infra-gitlab-minio/lock"
    lock_method    = "POST"
