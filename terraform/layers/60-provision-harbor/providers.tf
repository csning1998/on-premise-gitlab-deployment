...
terraform {
  ...
  backend "http" {
    address        = "https://gitlab.com/api/v4/projects/82448331/terraform/state/60-provision-harbor"
    lock_address   = "https://gitlab.com/api/v4/projects/82448331/terraform/state/60-provision-harbor/lock"
    unlock_address = "https://gitlab.com/api/v4/projects/82448331/terraform/state/60-provision-harbor/lock"
    lock_method    = "POST"
