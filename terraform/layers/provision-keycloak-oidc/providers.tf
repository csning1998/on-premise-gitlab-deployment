...
terraform {
  ...
  backend "http" {
    address        = "https://gitlab.com/api/v4/projects/82448331/terraform/state/provision-keycloak-oidc"
    lock_address   = "https://gitlab.com/api/v4/projects/82448331/terraform/state/provision-keycloak-oidc/lock"
    unlock_address = "https://gitlab.com/api/v4/projects/82448331/terraform/state/provision-keycloak-oidc/lock"
    lock_method    = "POST"
