...
locals {
  # Service Identity
  svc_name     = var.harbor_postgres_compute.cluster_identity.service_name
  comp_name    = var.harbor_postgres_compute.cluster_identity.component
  layer_number = var.harbor_postgres_compute.cluster_identity.layer_number
