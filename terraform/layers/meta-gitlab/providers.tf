...
terraform {
  ...
  backend "http" {
    address        = "https://gitlab.com/api/v4/projects/82448331/terraform/state/meta-gitlab"
    lock_address   = "https://gitlab.com/api/v4/projects/82448331/terraform/state/meta-gitlab/lock"
    unlock_address = "https://gitlab.com/api/v4/projects/82448331/terraform/state/meta-gitlab/lock"
    lock_method    = "POST"
