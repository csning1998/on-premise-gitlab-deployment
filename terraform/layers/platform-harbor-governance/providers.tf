...
terraform {
  ...
  backend "http" {
    address        = "https://gitlab.com/api/v4/projects/82448331/terraform/state/platform-harbor-governance"
    lock_address   = "https://gitlab.com/api/v4/projects/82448331/terraform/state/platform-harbor-governance/lock"
    unlock_address = "https://gitlab.com/api/v4/projects/82448331/terraform/state/platform-harbor-governance/lock"
    lock_method    = "POST"
