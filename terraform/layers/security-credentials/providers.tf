...
terraform {
  ...
  backend "http" {
    address        = "https://gitlab.com/api/v4/projects/82448331/terraform/state/security-credentials"
    lock_address   = "https://gitlab.com/api/v4/projects/82448331/terraform/state/security-credentials/lock"
    unlock_address = "https://gitlab.com/api/v4/projects/82448331/terraform/state/security-credentials/lock"
    lock_method    = "POST"
