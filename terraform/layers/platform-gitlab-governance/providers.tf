...
terraform {
  ...
  backend "http" {
    address        = "https://gitlab.com/api/v4/projects/82448331/terraform/state/platform-gitlab-governance"
    lock_address   = "https://gitlab.com/api/v4/projects/82448331/terraform/state/platform-gitlab-governance/lock"
    unlock_address = "https://gitlab.com/api/v4/projects/82448331/terraform/state/platform-gitlab-governance/lock"
    lock_method    = "POST"
