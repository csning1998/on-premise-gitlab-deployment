...
locals {
  ...
  svc_comp            = local.state.metadata.global_service_structure[local.svc_name].components["frontend"]
...
locals {
  ...
  net_config      = local.state.network.infrastructure_map[local.state.metadata.global_service_structure[local.svc_name].network.segment_key]
