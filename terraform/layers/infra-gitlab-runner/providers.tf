terraform {
  ...
  backend "http" {
    address        = "https://gitlab.com/api/v4/projects/82448331/terraform/state/infra-gitlab-runner"
    lock_address   = "https://gitlab.com/api/v4/projects/82448331/terraform/state/infra-gitlab-runner/lock"
    unlock_address = "https://gitlab.com/api/v4/projects/82448331/terraform/state/infra-gitlab-runner/lock"
    lock_method    = "POST"
