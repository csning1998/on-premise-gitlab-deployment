...
terraform {
  ...
  backend "http" {
    address        = "https://gitlab.com/api/v4/projects/82448331/terraform/state/40-provision-gitlab-databases"
    lock_address   = "https://gitlab.com/api/v4/projects/82448331/terraform/state/40-provision-gitlab-databases/lock"
    unlock_address = "https://gitlab.com/api/v4/projects/82448331/terraform/state/40-provision-gitlab-databases/lock"
    lock_method    = "POST"
