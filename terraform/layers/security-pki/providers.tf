...
terraform {
  ...
  backend "http" {
    address        = "https://gitlab.com/api/v4/projects/82448331/terraform/state/security-pki"
    lock_address   = "https://gitlab.com/api/v4/projects/82448331/terraform/state/security-pki/lock"
    unlock_address = "https://gitlab.com/api/v4/projects/82448331/terraform/state/security-pki/lock"
    lock_method    = "POST"
